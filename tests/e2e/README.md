...
1. Make sure to run `pnpm install`, `composer install` and `pnpm run build:client` before running the setup script.
2. Run the setup script `pnpm run test:e2e-setup` to spin up E2E environment in docker containers.
